...
import { ArrowLeft, Upload, Calendar, User, MessageSquare, Loader2, CheckCircle, AlertCircle, Download, Copy, Eye, EyeOff } from 'lucide-react';
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 p-6 relative overflow-hidden">
        ...
        <div className="max-w-3xl mx-auto relative z-10">
          <MagicCard className="bg-black/40 backdrop-blur-lg border-green-500/20 hover:border-green-500/40">
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 p-6 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        <MagicCard className="bg-black/40 backdrop-blur-lg border-purple-500/20 hover:border-purple-500/40">
          <div className="p-8">
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              ...
              >
                ...
                <MagicCard className={`border-2 border-dashed transition-all duration-300 ${
                  dragActive
                    ...
                    : 'border-gray-500 hover:border-purple-500/50'
                }`}>
                  <div
                    ...
                    {formData.file ? (
                      ...
                      >
                        {previewUrl && (
                          <img 
                            src={previewUrl} 
                            alt="Preview" 
                            className="w-32 h-32 object-cover rounded-xl mx-auto shadow-lg shadow-purple-500/25"
                          />
                        )}
                      ...
                      <div>
                        ...
                        <p className="text-gray-300 mb-2 text-lg">
                          ...
                          <label className="text-purple-400 hover:text-purple-300 cursor-pointer font-medium underline decoration-purple-400/50 hover:decoration-purple-300">
                            browse
                            <input
                              type="file"
                              className="hidden"
              ...
              >
                ...
                <MagicCard className="p-1">
                  <input
                    ...
                    className="w-full px-4 py-4 bg-black/40 border-0 rounded-xl text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-purple-500/50 transition-all"
                ...
                <div>
                  ...
                  <MagicCard className="p-1">
                    <input
                      ...
                      className="w-full px-4 py-4 bg-black/40 border-0 rounded-xl text-white focus:outline-none focus:ring-2 focus:ring-purple-500/50 transition-all"
              ...
              >
                ...
                <MagicCard className="p-1">
                  <textarea
                    ...
                    rows={4}
                    className="w-full px-4 py-4 bg-black/40 border-0 rounded-xl text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-purple-500/50 transition-all resize-none"
