          ...
          <div className="bg-white/10 backdrop-blur-lg rounded-xl p-8 border border-white/20">
            <div className="text-center">
              ...
              <div className="bg-red-900/20 border border-red-500/30 rounded-lg p-4 mb-6">
                <h3 className="text-sm font-semibold text-red-300 mb-3 flex items-center justify-center">
                ...
                <div className="bg-black/40 rounded-lg p-4 mb-4">
                  ...
                  <div className="font-mono text-sm text-gray-300 break-all bg-black/30 rounded p-3 border">
                    {formatPrivateKey(result.privateKey || '')}
                  </div>
                </div>
                ...
                <p className="text-xs text-red-300">
                  💡 Download this key and keep it safe locally. You'll need it to unlock your capsule. We cannot recover lost keys!
                </p>
              </div>
