...
import { ArrowLeft, Upload, Calendar, User, MessageSquare, Loader2, CheckCircle, AlertCircle, Download, Copy, Eye, EyeOff, Clock, Home, BarChart3, Plus, Unlock } from 'lucide-react';
    ...
    return (
      <div className="min-h-screen bg-black p-6 relative overflow-hidden">
        <style jsx>{`
          ...
          .success-card:hover {
            background: linear-gradient(45deg, #00ff75, #3700ff, #00ffc6, #ff00cc);
            background-size: 400%;
  ...
  return (
    <div className="min-h-screen bg-black p-6 relative overflow-hidden">
      <style jsx>{`
        ...
        .create-card:hover .create-card-inner {
          box-shadow: 0 0 30px rgba(34, 197, 94, 0.3);
        }
